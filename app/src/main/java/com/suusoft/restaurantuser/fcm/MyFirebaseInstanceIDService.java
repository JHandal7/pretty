...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Log.d(TAG, "GCM Registration sending .... " + token);
        // TODO: 6/27/2016 Need to update send key to server
        RequestManager.registerDevice(token, AppUtil.getMacAddress(this), new BaseRequest.CompleteListener() {

            @Override
            public void onSuccess(ApiResponse response) {
                Log.e(TAG, "GCM Registration .... " + "saved");

            }

            @Override
            public void onError(String message) {
                Log.e(TAG, "GCM Registration false .... " + message);
            }
        });
