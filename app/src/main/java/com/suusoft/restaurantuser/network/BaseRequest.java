...
import com.suusoft.restaurantuser.network.multipart.MultiPartRequest;
...
public class BaseRequest {
    ...
    private static final String PARAM_APPLICATON_ID = "application_id";
...
//        params.put(PARAM_APPLICATON_ID, AppController.getInstance().getPackageName());
    ...
    public void request(final int method, String url, HashMap<String, String> params, final boolean isShowProgress, final boolean isCaching, final CompleteListener listener,
        ...
        if (NetworkUtility.isNetworkAvailable()) {
            ...
            Log.e(TAG, "request params:" + params.toString());
            ...
            Log.e(TAG, "starting request url:" + url);
    ...
    private void requestMultipart(String url, HashMap<String, String> paramsString, HashMap<String, String> paramsFile, final boolean isShowProgress, final CompleteListener listener, String tag) {
        if (NetworkUtility.isNetworkAvailable()) {
            ...
            Log.e(TAG, "request params:" + paramsString.toString());
            Log.e(TAG, "request file:" + paramsFile.toString());
